...
from with_report.rounding import round_two_axis, round_col_axis
...
def ch_ranking_df(media_df, ga_df, col_name, metric_set, trans_metric_set, group_period, condition_set):
    ...
    reported_ga_df = report_ga_add(reported_media_df, calculated_ga_df)
...
def ch_df(ch_ranking_df, col_name, col_value, group_period, period_set):
